...
(function() {
		...
		return {
			...
			on: function(b, d, g, k, l) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					m.fn = d;
					m.priority = l;
					for (var r = e.length - 1; 0 <= r; r--) if (e[r].priority <= l) return e.splice(r + 1, 0, m), {
						removeListener: u
					};
					e.unshift(m)
				}
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			buildStyleHtml: function(a) {
				a = [].concat(a);
				for (var e, b = [], c = 0; c < a.length; c++) if (e = a[c]) / @import | [{}] / .test(e) ? b.push("<style>" + e + "</style>") : b.push('<link type="text/css" rel=stylesheet href="' + e + '">');
				return b.join("")
			},
			htmlEncode: function(a) {
				return void 0 === a || null === a ? "" : String(a).replace(b, "&amp;").replace(c, "&gt;").replace(f, "&lt;")
			},
			...
			transformPlainTextToHtml: function(a, e) {
				...
				c = c.replace(/\n/g, "<br>");
				b || (c = c.replace(new RegExp("<br>(?=</" + l + ">)"), function(a) {
					return CKEDITOR.tools.repeat(a, 2)
				}));
				c = c.replace(/^ | $/g, "&nbsp;");
				return c = c.replace(/(>|\s) /g, function(a, e) {
					return e + "&nbsp;"
				}).replace(/ (?=<)/g, "&nbsp;")
			},
			...
			getCookie: function(a) {
				a = a.toLowerCase();
				for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++) if (c = b[d].split("="), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a) return decodeURIComponent(1 < c.length ? c[1] : "");
				return null
			},
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
		...
		getIndex: function(a) {
			function d(a, c) {
				...
				return m && m.nodeType == CKEDITOR.NODE_TEXT ? b(m) ? d(m, c) : m : null
			}
			...
			do a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (g || b(c)) || (f++, g = c.nodeType == CKEDITOR.NODE_TEXT);
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++) if (e) for (var r = 0; r < e.length; r++) b.push([a, c[d], e[r]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				} else for (q = this, w = null; q && "body" != q.getName() && "html" != q.getName();) {
				...
				document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || r || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
				return {
					x: b,
					y: c
				}
			...
			copyAttributes: function(a, b) {
				...
				for (var e = 0; e < c.length; e++) {
					var d = c[e],
						...
						g;
					if (!(f in b)) if ("checked" == f && (g = this.getAttribute(f))) a.setAttribute(f, g);
	...
	(function() {
		function a(a, b) {
			...
			this.current ? e = this.current[n](!1, p, v) : (a ? e.type == CKEDITOR.NODE_ELEMENT && (e = 0 < A ? e.getChild(A - 1) : !1 === v(e, !0) ? null : e.getPreviousSourceNode(!0, p, v)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === v(d, !0) ? null : d.getNextSourceNode(!0, p, v)))), e && !1 === v(e) && (e = null));
			for (; e && !this._.end;) {
				this.current = e;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = u(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(A) && e(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, f) {
			...
			function k() {
				var b = I - 1,
					c = C && u && !p.equals(n);
				b < F - 1 || b < K - 1 || c ? (c ? a.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START) : K == b + 1 && E ? a.moveToPosition(B[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(B[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = N[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('<span data-cke-bookmark="1" style="display:none">&nbsp;</span>', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
					startNode: c
				}))) : a.collapse(!0)
			}
			a.optimizeBookmark();
			...
			if (h && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(y, z)), c.append(p);
				...
				G = c;
				for (Q = I; Q <= K; Q++) if (c = B[Q], U = c.getPrevious(), c.equals(N[Q])) b && (G = G.getChild(0));
				else {
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark: function(a) {
				...
				q || (c = b.clone(), c.setHtml("&nbsp;"), a && c.setAttribute("id", d + "E"), f = this.clone(), f.collapse(), f.insertNode(c));
				f = this.clone();
				f.collapse(!0);
				f.insertNode(b);
				c ? (this.setStartAfter(b), this.setEndBefore(c)) : this.moveToPosition(b, CKEDITOR.POSITION_AFTER_END);
				return {
					startNode: a ? d + (q ? "C" : "S") : b,
					endNode: a ? d + "E" : c,
					serializable: a,
					collapsed: q
				}
			...
			enlarge: function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					for (h = c(h); h || p;) {
						...
						for (; p;) if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
							...
							else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
								J = p.getText();
								if (d.test(J)) p = null;
								else for (var E = p.$.getElementsByTagName("*"), C = 0, u; u = E[C++];) if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) {
									p = null;
									break
								}
								p && (z = !! J.length)
						...
						for (; p;) {
							...
							if (p.type == CKEDITOR.NODE_TEXT) J = p.getText(), q(p, 0) || (p = null), z = /^[\s﻿]/.test(J);
								...
								if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
									J = p.getText();
									if (d.test(J)) p = null;
									else for (E = p.$.getElementsByTagName("*"), C = 0; u = E[C++];) if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) {
										p = null;
										break
									}
									p && (z = !! J.length)
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					...
					var m, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
						br: 1
					} : null),
						B = null,
						I = function(a) {
					...
					h = h.lastBackward();
					m = m || k;
					this.setStartAt(m, !m.is("br") && (!h && this.checkStartOfBlock() || h && m.contains(h)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
			...
			shrink: function(a, b, c) {
				if (!this.collapsed) {
					...
					q && q.type == CKEDITOR.NODE_TEXT && (k ? k >= q.getLength() ? d.setEndAfter(q) : (d.setEndAfter(q), v = 0) : d.setEndBefore(q));
			...
			splitBlock: function(a, b) {
				...
				this.deleteContents();
				f && f.equals(q) && (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(q, CKEDITOR.POSITION_AFTER_END), q = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (q = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
				return {
					previousBlock: f,
					nextBlock: q,
					wasStartOfBlock: c,
			...
			_find: function(a, b) {
				var c = this.getCommonAncestor(),
					...
					f = [],
					q, g, k, l;
				if (c && c.find) for (g = c.find(a), q = 0; q < g.count(); q++) if (c = g.getItem(q), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED, k && l && f.push(c);
				return f
			}
		}
	})();
				...
				for (this._.nextNode = null; w;) {
					...
					if (v) w.type == CKEDITOR.NODE_TEXT && f.test(w.getText()) && (v = 0);
						...
						if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) {
							...
							b(this, a, d);
							break
						} else if (w.isBlockBoundary(this.forceBrBreak && !t && {
							br: 1
						})) {
							if ("br" == p) v = 1;
					...
					if (k && !H) for (; !w.getNext(l) && !r;) {
						p = w.getParent();
						if (p.isBlockBoundary(this.forceBrBreak && !t && {
							br: 1
						})) {
							H = 1;
							v = 0;
	...
	(function() {
		function a(a, b, c, d, f) {
			...
			for (h in b) {
				...
				for (F in O) {
					...
					for (; K = B.pop();) y[K] = y["!" + K], delete y["!" + K];
					q[g] = (z ? !1 : v) || null
				}
			...
			for (d = a.length; c < d; ++c) {
				...
				if (!0 === h.elements || null === h.elements) f[p ? "unshift" : "push"](h);
				else for (E in n = h.elements, delete h.elements, n) if (b[E]) b[E][p ? "unshift" : "push"](h);
				else b[E] = [h]
			}
		}
		...
		function d(a, c, d, h) {
			if (!a.match || a.match(c)) if (h || l(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
				...
				if (a) if (!0 === a) a = !0;
					...
					for (var p = 0, f = c.length, n; p < f; ++p) n = c[p], h[n] || (h[n] = a(n));
					a = !1
				} else a = !1;
				d.allClasses = a
			}
		...
		function h(a, b, c) {
			...
			else if (E.$block[d] || "tr" == d) if ("br" == b) a.previous && !v(a.previous) && (b = t(), b.insertBefore(a)), a.next && !v(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren();
			else {
				var d = a.children,
					h;
				b: {
		...
		function n(a, b) {
			...
			for (f in h) if (a.styles[f] != h[f]) return !1;
			return !0
		}
		...
		CKEDITOR.filter = function(a) {
			...
			if (a instanceof CKEDITOR.editor) {
				...
				!0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(P[a.enterMode] + " " + P[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				if ("string" == typeof b) b = e(b);
					...
					d && (d = C(d), h.classes = d["class"] ? d["class"].split(/\s+/) : null, h.requiredClasses = h.classes, delete d["class"], h.attributes = d, h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
			...
			applyTo: function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						...
						if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (e = x(p, a, f, F), e & 1) g = !0;
				...
				case "it":
					...
					break;
				case "el-up":
					c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || h(c, d, a);
					break;
				case "parent-down":
				...
				if (!this.disabled && a) {
					...
					for (h = 0; h < a.length; ++h) {
						...
						var p = void 0,
							...
							v = void 0;
						c = [];
						for (f = 0; f < b.length; ++f) n = b[f], "string" == typeof n ? (n = n.split(/\s*:\s*/), e = n[0], g = null, v = n[1]) : (e = n.check, g = n.left, v = n.right), p || (p = n, p = p.element ? p.element : e ? e.match(/^([a-z0-9]+)/i)[0] : p.left.getDefinition().element), g instanceof CKEDITOR.style && (g = z(g)), c.push({
							check: e == p ? null : e,
							left: g,
			...
			check: function(a, b, c) {
				...
				if (!1 !== b && (v = this._.transformations[h.name])) {
					for (d = 0; d < v.length; ++d) p(this, h, v[d]);
					q(h)
				}
				x(this, n, g, {
					doFilter: !0,
			...
			transform: function(a, b) {
				if ("string" == typeof b) a.name = b;
					...
					var c = b.getDefinition(),
						...
						p, n, f, e;
					a.name = c.element;
					for (p in h) if ("class" == p) for (c = a.classes.join("|"), f = h[p].split(/\s+/); e = f.pop();) - 1 == c.indexOf(e) && a.classes.push(e);
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, d, b) {
			...
			for (var c = this.loaded, f = this.registered, g = [], k = {}, l = {}, m = 0; m < a.length; m++) {
				var u = a[m];
				if (u) if (c[u] || f[u]) l[u] = this.get(u);
				else {
	...
	(function() {
		...
		function A(a) {
			...
			if (d) var h = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
				c = c.replace(h, ""),
				c = c + ("," + d);
			if (f) var p = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
				c = c.replace(p, "");
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			setKeystroke: function() {
				for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [
					[].slice.call(arguments, 0)], c, d, f = b.length; f--;) c = b[f], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
			},
			addFeature: function(a) {
		...
		CKEDITOR.htmlParser.prototype = {
			...
			parse: function(b) {
				for (var c, f, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
					f = c.index;
					if (f > g) if (g = b.substring(g, f), k) k.push(g);
					else this.onText(g);
			...
			D.onTagOpen = function(f, n, e, g) {
				...
				if (a(n)) w.push(n);
					...
					if ("br" == f) H.push(n);
						...
						for (; !(g = (e = t.name) ? CKEDITOR.dtd[e] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || t.isUnknown || g[f]);) if (t.isOptionalClose) D.onTagClose(e);
						...
						else if (f in CKEDITOR.dtd.$listItem && !x(f, e)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					l = k.length,
					m, u, e, A;
				for (A = 0; A < l; A++) if (d && (m = c.type, u = c.name), e = k[A], !(a.nonEditable && !e.options.applyToAll || a.nestedEditable && e.options.excludeNestedEditable)) {
	...
	(function() {
		function a(a, d) {
			...
			function n(a, d) {
				return function(h) {
					if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (f = !a || !1 !== ("function" == typeof d ? d(h) : d)) y || CKEDITOR.env.needsBrFiller || h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (f = b(h), f = !f || "form" == h.name && "input" == f.name) : f = !1 : f = !1;
						f && h.add(e(a))
					}
				}
			}
			...
			function p(a, b) {
				...
				var c;
				return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(w)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in B) || !y && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
			}
			var v = {
				elements: {}
			},
		...
		function e(a, b) {
			return a.replace(b, function(a, b, c) {
				0 === a.indexOf("<textarea") && (a = b + x(c).replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</textarea>");
		...
		function r(a) {
			return a.replace(/<!--(?!{cke_protected})[\s\S]+?-->/g, function(a) {
				return "<!--" + H + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "-->"
			})
		}
		...
		function q(a, b) {
			...
			a = a.replace(f, function(a, b, d) {
				return "<!--" + H + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "-->"
			});
		...
		CKEDITOR.htmlDataProcessor = function(b) {
			...
			b.on("toHtml", function(a) {
				...
				var c = a.dataValue,
					...
					c = c.replace(I, "<cke:$1$2></cke:$1>"),
					c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
					c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2");
				h = a.context || b.editable().getName();
				var f;
				CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == h && (h = "div", c = "<pre>" + c + "</pre>", f = 1);
		...
		var w = /(?:&nbsp;| )$/,
			...
			h = CKEDITOR.tools.extend({}, t.$blockLimit, t.$block),
			p = {
				elements: {
					input: l,
					textarea: l
	...
	(function() {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				var m, u;
				for (m in k) {
					for (l = k[m];;) if (u = a.onAttributeName(b, m)) if (u != m) delete k[m], m = u;
					else break;
					else {
						delete k[m];
						break
					}
					u && (!1 === (l = a.onAttribute(b, d, u, l)) ? delete k[u] : k[u] = l)
				}
	...
	(function() {
		...
		function b(a) {
			var b = a.name,
				...
				u = new CKEDITOR.template('<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir="{langDir}" lang="{langCode}" role="application"' + (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : "") + ">" + (a.title ? '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' : "") + '<{outerEl} class="cke_inner cke_reset" role="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" role="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'),
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
			...
			k.setSize("width", a, !0);
			u && (u.style.width = "1%");
			var e = (k.$.offsetHeight || 0) - (m.$.clientHeight || 0),
	...
	(function() {
		function a(a) {
			...
			}, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;| )$/) && b.remove(), l = 1, a.cancel());
			l && g.select()
		}
			...
			proto: {
				...
				setup: function() {
					...
					if (!this.is("textarea")) {
						...
						f.setCustomData("stylesheet_ref", n + 1);
						...
						this.attachListener(a, "key", function(b) {
							...
							if (c in l) {
								...
								var h, f = b.getRanges()[0],
									n = f.startPath(),
									p, k, y, c = 8 == c;
								CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h = b.getSelectedElement()) || (h = g(b)) ? (a.fire("saveSnapshot"), f.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START), h.remove(), f.select(), a.fire("saveSnapshot"), d = 1) : f.collapsed && ((p = n.block) && (y = p[c ? "getPrevious" : "getNext"](e)) && y.type == CKEDITOR.NODE_ELEMENT && y.is("table") && f[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"), f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && p.remove(), f["moveToElementEdit" + (c ? "End" : "Start")](y), f.select(), a.fire("saveSnapshot"), d = 1) : n.blockLimit && n.blockLimit.is("td") && (k = n.blockLimit.getAscendant("table")) && f.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (y = k[c ? "getPrevious" : "getNext"](e)) ? (a.fire("saveSnapshot"), f["moveToElementEdit" + (c ? "End" : "Start")](y), f.checkStartOfBlock() && f.checkEndOfBlock() ? y.remove() : f.select(), a.fire("saveSnapshot"), d = 1) : (k = n.contains(["td", "th", "caption"])) && f.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
							}
							return !d
						});
						...
						CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
							...
							if (b in l) {
								...
								e = b.block,
								d = c.endPath().block,
								e && d && !e.equals(d) ? (a.fire("saveSnapshot"), (h = e.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(e, !1), b.lastElement.mergeSiblings(), u(e, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
								if (!b) return;
				...
				if (a && a.isInline()) {
					...
					if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents"))) {
						var f = CKEDITOR.tools.getNextId(),
							d = CKEDITOR.dom.element.createFromHtml('<span id="' + f + '" class="cke_voice_label">' + d + "</span>");
						c.append(d);
		...
		q = function() {
			...
			function b(c, d) {
				...
				for (var k = E[k.getName()], y = 0, l = c.getChildren(), z = l.count(), J = -1, m = -1, q = 0, u = f.contains(E.$list); y < z; ++y) f = l.getItem(y), a(f) ? (n = f.getName(), u && n in CKEDITOR.dtd.$list ? g = g.concat(b(f, d)) : (p = !! k[n], "br" != n || !f.data("cke-eol") || y && y != z - 1 || (q = (e = y ? g[y - 1].node : l.getItem(y + 1)) && (!a(e) || !e.is("br")), e = e && a(e) && E.$block[e.getName()]), -1 != J || p || (J = y), p || (m = y), g.push({
					...
					node: f,
					allowed: 1
				}); - 1 < J && (g[J].firstNotAllowed = 1); - 1 < m && (g[m].lastNotAllowed = 1);
				return g
			}
			...
			return function(m, C, B, I) {
				...
				if (!I.checkReadOnly()) {
					var G = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit || I.root;
					m = {
						type: C,
						dontFilter: K,
						editable: m,
					...
					I = m.mergeCandidates;
					var L, r;
					"text" == m.type && C.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (L = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", C.document), C.insertNode(L), C.setStartAfter(L));
						...
						for (J(C, x); I < C.length; I++) {
							...
							if (t = G.isLineBreak) {
								...
								G.hasBlockSibling ? t = 1 : (T = t.startContainer.getAscendant(E.$block, 1)) && T.is({
									div: 1,
									p: 1
								}) ? (aa = T.getPosition(R), aa == CKEDITOR.POSITION_IDENTICAL || aa == CKEDITOR.POSITION_CONTAINS ? t = 0 : (R = t.splitElement(T), t.moveToPosition(R, CKEDITOR.POSITION_AFTER_START), t = 1)) : t = 0
							}
							if (t) B = 0 < I;
							else {
								t = x.startPath();
					...
					for (X = D.createBookmark(); M = m.zombies.pop();) M.getParent() && (H = D.clone(), H.moveToElementEditStart(M), H.removeEmptyBlocksAtEnd());
		...
		w = function() {
			...
			return function(d) {
				...
				e.is("table") ? (d.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), e.remove()) : (e.is({
					...
					thead: 1,
					tfoot: 1
				}) && (e = b(e, "tr", g)), e.is("tr") && (e = b(e, e.getParent().is("thead") ? "th" : "td", g)), (f = e.getBogus()) && f.remove(), d.moveToPosition(e, g ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END))
			}
		}();
		H = {
			eol: {
				...
				table: function() {
					function a(c) {
						...
						h.guard = function(a, h) {
							...
							else if (!h && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f);
							else {
					...
					return {
						...
						detectRanges: function(e, f) {
							...
							m = m.contains("table");
							l = l.contains("table");
							if (m || l) m && l && b(m, l) ? (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = h.clone(), g.setEndAt(m, CKEDITOR.POSITION_AFTER_END), k = h.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : m ? l || (e.tableSurroundingRange = g, g.setStartAt(m, CKEDITOR.POSITION_AFTER_END), h.setEndAt(m, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), h.setStartAt(l, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = k ? k : a(h)
						},
			...
			getRanges: function() {
				...
				function() {
					...
					var b = function(b, c) {
							...
							for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, B = -1, n, m; k <= l;) if (B = Math.floor((k + l) / 2), f = e[B], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) l = B - 1;
							else if (0 > n) k = B + 1;
							else return {
								container: d,
								offset: a(f)
							...
							for (; 0 < g;) try {
								h = f[0 < n ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, m = h), f = h
							} catch (K) {
								return {
									container: d,
									offset: a(f)
				...
				if (a.length) if (this.isLocked) {
					...
					if (l) this.fake(l);
						...
						if (A) {
							...
							a = l.collapsed;
							var u, r, t;
							if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in v && (!c.is("a") || !c.getText())) try {
							...
							e ? (m = l.document.$.body.createTextRange(), m.moveToElementText(e.$), t.setEndPoint("EndToEnd", m), t.moveEnd("character", -1)) : (u = b.getNext(q), r = b.hasAscendant("pre"), u = !(u && u.getText && u.getText().match(m)) && (r || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), r = l.document.createElement("span"), r.setHtml("&#65279;"), r.insertBefore(b), u && l.document.createText("﻿").insertBefore(b));
							l.setStartBefore(b);
							b.remove();
							a ? (u ? (t.moveStart("character", -1), t.select(), l.document.$.selection.clear()) : t.select(), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START), r.remove()) : (l.setEndBefore(e), e.remove(), t.select())
						} else {
							e = this.getNative();
							if (!e) return;
	...
	(function() {
				...
				for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					...
					if (r.equals(u)) r = null, l = !0;
						...
						var x = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
							...
							A = x && r.getAttribute("data-nostyle");
						...
						if (y) if (z = r.getParent(), y = h, C = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[C] && !E || y.parentRule && !y.parentRule(z)) l = !0;
						else {
							if (t || x && CKEDITOR.dtd.$removeEmpty[x] && (r.getPosition(u) | O) != O || (t = c.clone(), t.setStartBefore(r)), x = r.type, x == CKEDITOR.NODE_TEXT || v || x == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
								for (var x = r, P;
					...
					if (l && t && !t.collapsed) {
						for (var l = H(this, e), v = l.hasAttributes(), A = t.getCommonAncestor(), x = {}, y = {}, z = {}, C = {}, S, V, ca; l && A;) {
							if (A.getName() == g) {
								for (S in h.attributes)!C[S] && (ca = A.getAttribute(V)) && (l.getAttribute(S) == ca ? y[S] = 1 : C[S] = 1);
		...
		function m(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), u(d, e)) : x.call(this, d));
			a.moveToBookmark(b)
		}
		...
		CKEDITOR.style = function(a, b) {
			...
			this.type = a.type || (z[c] ? CKEDITOR.STYLE_BLOCK : J[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
	...
	(function() {
		...
		CKEDITOR.dom.elementPath = function(b, f) {
			...
			if (m.type == CKEDITOR.NODE_ELEMENT) {
				...
				if (m.equals(f)) break;
				if (!k && (u = m.getName(), "true" == m.getAttribute("contenteditable") ? k = m : !g && d[u] && (g = m), a[u])) {
					if (u = !g && "div" == u) {
						a: {
							u = m.getChildren();
	...
	(function() {
		function q(a, e) {
			...
			var p = a.ui.spaceId("path"),
				...
				q = k.idBase;
			e.html += '<span id="' + p + '_label" class="cke_voice_label">' + a.lang.elementspath.eleLabel + '</span><span id="' + p + '" class="cke_path" role="group" aria-labelledby="' + p + '_label"><span class="cke_path_empty">&nbsp;</span></span>';
			a.on("uiReady", function() {
		...
		var x = CKEDITOR.addTemplate("pathItem", '<a id="{id}" href="{jsTitle}" tabindex="-1" class="cke_path_item" title="{label}"' + e + ' hidefocus="true"  onkeydown="return CKEDITOR.tools.callFunction({keyDownFn},{index}, event );" onclick="CKEDITOR.tools.callFunction({clickFn},{index}); return false;" role="button" aria-label="{label}">{text}</a>');
