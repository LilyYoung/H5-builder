                ...
                <div class="gome-modal-list">
                    <div>
                        ...
                        <div class="tab-pane active tab-head">
                            ...
                            <ul class="cat_two_list category-title clearfix">
                        ...
                        <div class="tab-pane active tab-head hidden">
                            <div class="category-group">
                                <span class="manage-box group-wrap">
                                    ...
                                    <a href="javascript:;" class="mul-del">删除</a>
                                    <a href="javascript:;" class="cancel-all">取消选择</a>
                                </span>

                                <span class="assign-group-box  group-wrap" data-toggle="dropdown"><a href="javascript:;" class="assign-group">分组</a></span>
